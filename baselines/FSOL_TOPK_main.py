...
# what's our WRS computation resolution? How many timesteps are we recording metrics at?
...
thetat_dense = np.zeros(shape=(D,)) # 1/31/2024: let's make this a FLATTENED ARRAY!
